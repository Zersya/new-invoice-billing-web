<template>
  ...
  <div
      :class="[`relative shadow-xl top-0 z-40 left-0 w-16 h-screen transition-all ease-in-out -translate-x-full sm:translate-x-0 hover:w-96`, `${isSidebarOpen ? 'w-96': ''}`]">
    <div class="px-3 py-4 h-full overflow-x-hidden overflow-y-auto bg-gray-50 dark:bg-gray-800">
      ...
      <ul class="space-y-2">
        ...
        <span class="border-t border-gray-200 dark:border-gray-700"/>
