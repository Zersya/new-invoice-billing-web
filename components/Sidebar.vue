<template>
  <FormMerchant/>
  <div
      class="shadow-xl top-0 left-0 z-40 w-16 h-screen transition-transform -translate-x-full sm:translate-x-0"
      aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <a href="https://app.inving.co/" class="flex items-center mb-5">
        <img src="/logo-inving.png" alt="Inving Logo"/>
      </a>
      <div class="border-t border-gray-200 dark:border-gray-700"/>
      <ul class="space-y-2">
        <li>
          <a href="#"
             class="h-10 my-3 flex justify-center items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
            <img class="rounded-full" src="/logo-rone.png" alt="Rounded avatar">
          </a>
        </li>
        <li>
          <a href="#"
             class="h-10 my-3 flex justify-center items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
            <img class="rounded-full self-center" src="/logo-ttid.png" alt="Rounded avatar">
          </a>
        </li>
        <li>
